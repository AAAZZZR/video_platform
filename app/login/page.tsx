  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="border border-zinc-800 rounded-xl bg-zinc-900/50 p-6 space-y-5">
          {/* Google login */}
          <button
            onClick={handleGoogleLogin}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-zinc-100 text-zinc-900 font-medium py-3 px-4 rounded-lg transition-colors cursor-pointer"
          >
          ...
          <form onSubmit={handleEmailAuth} className="space-y-3">
            <div>
              <label className="block text-xs text-zinc-500 mb-1.5">{t("login.email")}</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-xs text-zinc-500 mb-1.5">{t("login.password")}</label>
              <input
                type="password"
                value={password}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold py-3 px-4 rounded-lg transition-all disabled:opacity-40 cursor-pointer"
            >
